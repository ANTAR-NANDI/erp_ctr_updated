                                    ...
                                    <?php foreach ($t as $approve) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a id="approve" href="" onclick="this.href='<?php echo base_url("Crqsn/isactive/$id/active/$product_id/") ?>'+$(this).closest('tr').find('.a_qty').val();return confirm('<?php echo display("are_you_sure") ?>')  " class="btn btn-info btn-sm " data-toggle="tooltip" data-placement="right" title=""><i class="fa fa-check" aria-hidden="true"></i></a>
                                                ...
                                                <?php if ($this->permission1->method('aprove_v', 'delete')->access()) { ?>
                                                    <a href="<?php echo base_url("Crqsn/rqsn_delete_center/$rqsn_id/$product_id/") ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure?')" title="delete"><i class="fa fa-trash"></i></a>
                                                <?php } ?>
