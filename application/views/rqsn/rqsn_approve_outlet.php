                                            ...
                                            <td><input type="checkbox" class="data-check flat-green"></td>
                                                ...
                                                <td>
                                                    ...
                                                    if ($this->permission1->method('aprove_v', 'delete')->access()) { ?>
                                                        <a href="<?php echo base_url("Crqsn/outlet_rqsn_delete/$rqsn_id/$product_id") ?>" class="btn btn-danger" onclick="return confirm('Are You Sure?')" title="delete"><i class="fa fa-trash"></i></a>
                                                    <?php } ?>
