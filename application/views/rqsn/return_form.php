                                    ...
                                    <div class="col-sm-6">
                                        <select name="to_id" class="form-control" required="" tabindex="3">
                                            <!-- <?php foreach ($cw_list as $cw) { ?>
                                                <option value="<?php echo html_escape($cw['warehouse_id']) ?>" <?php echo html_escape($cw['warehouse_id']) == $own_outlet_id ? 'disabled' : '' ?>><?php echo html_escape($cw['central_warehouse']); ?></option>
                                            <?php } ?>
                                            <?php foreach ($outlet_list_to as $outlet) { ?>
                                                <option value="<?php echo html_escape($outlet['outlet_id']) ?>" <?php echo html_escape($outlet['outlet_id']) == $own_outlet_id ? 'disabled' : '' ?>><?php echo html_escape($outlet['outlet_name']); ?></option>
                                            <?php } ?> -->
