                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="rqsn_panel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="date" class="col-sm-4 col-form-label">Validity Type<i class="text-danger">*</i></label>
                                    <div class="col-sm-8">


                                        <select name="is_exp" id="is_exp" class="form-control" required="" tabindex="3">
