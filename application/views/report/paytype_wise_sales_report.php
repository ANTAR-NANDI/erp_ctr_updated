                                ...
                                <table id="pywiseSaleReportTable" class="table table-bordered table-striped table-hover">
                                        ...
                                        foreach ($sales_data as $k => $v) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    $total += $v['pay_type_cash'];
                                                    ?>
                                                </td>

                                                <td class="text-right">
                                                    <?= number_format($v['pay_type_bkash'], 2);
                                                    $total += $v['pay_type_bkash']; ?>
                                                </td>

                                                <td class="text-right">
                                                    <?= number_format($v['pay_type_nagad'], 2);
                                                    $total += $v['pay_type_nagad']; ?>
                                                </td>

                                                <td class="text-right">
                                                    <?= number_format($v['pay_type_bank'], 2);
                                                    $total += $v['pay_type_bank']; ?>
                                                </td>

                                                <td class="text-right">
                                                    <?= number_format($v['pay_type_card'], 2);
                                                    $total += $v['pay_type_card']; ?>
                                                </td>

                                                <td class="text-right">
                                                    <?= number_format($v['pay_type_cheque'], 2);
                                                    $total += $v['pay_type_cheque']; ?>
                                                </td>

                                                <td class="text-right">
                                                    <?= number_format($v['pay_type_rocket'], 2);
                                                    $total += $v['pay_type_rocket']; ?>
                                                </td>
                                                <td class="text-right">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?= number_format($day_total_cheque, 2); ?>
                                            </td>
