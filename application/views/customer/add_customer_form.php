            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6">
                            <!-- <div class="form-group row">
                                <label for="customer_name" class="col-sm-4 col-form-label">Chamak Card No:</label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="friend_card" id="friend_card" type="text" placeholder="Chamak Card" tabindex="1">
                                </div>
                            </div> -->
                            <div class="form-group row">
