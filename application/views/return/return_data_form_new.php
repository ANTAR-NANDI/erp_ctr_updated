 ...
 <script src="<?php echo base_url() ?>my-assets/js/admin_js/return_new.js" type="text/javascript"></script>
 <!-- Edit Invoice Start -->
                                     ...
                                     <table class="table table-bordered table-hover" id="">
                                         ...
                                         <tbody id="">
                                             ...
                                             <tr>
                                                 <td class="product_field">
                                                     <input type="text" name="product_name" value="{sku}-{product_name}" class="form-control productSelection" required placeholder='<?php echo display('product_name') ?>' id="product_names" tabindex="3" readonly="">
                                                 ...
                                                 <td>
                                                     <input type="number" onkeyup="quantity_calculate_new({sl});" onkeypress="quantity_calculate_new({sl});" class="total_return_qntt_{sl} form-control text-right" id="total_return_qntt_{sl}" value="" min="0" placeholder="0.00" tabindex="4" />

                                                 </td>

                                                 <td>
                                                     <input type="text" value="{rate}" id="price_item_{sl}" class="price_item{sl} form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                 </td>
                                                 <td hidden>
                                                     <input type="text" value="{sum_amount}" id="product_rate_total_{sl}" class="product_rate_total_{sl} form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                     <input type="text" name="item_total_discounted_price_wd[]" value="{item_total_discounted_price_wd}" id="item_total_discounted_price_wd_{sl}" class="item_total_discounted_price_wd_{sl} form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                     <input type="text" name="vat[]" value="{vat}" id="vat_{sl}" class="vat_{sl} form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                     <input type="text" name="tax[]" value="{total_tax}" id="tax_{sl}" class="tax_{sl} form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                 </td>

                                                 <td>
                                                     <input type="text" id="total_rate_return_{sl}" class="form-control text-right" placeholder="0.00" value="0.00" readonly min="0" tabindex="6" />
                                                     <input type="hidden" value="0.00" id="item_total_discounted_price_wd_return_{sl}" class="item_total_discounted_price_wd_return_{sl} form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                     <input type="hidden" value="0.00" id="vat_return_{sl}" class="vat_return form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                     <input type="hidden" value="0.00" id="tax_return_{sl}" class="tax_return form-control text-right" min="0" tabindex="5" required="" placeholder="0.00" readonly="" />
                                                 </td>

                                                 <td hidden>
                                                     <input type="text" readonly id="discount_per_{sl}" class="form-control text-right" placeholder="0.00" value="{discount_per}" min="0" tabindex="6" />
                                                     <input type="text" readonly id="distributed_discount_{sl}" class="form-control text-right" placeholder="0.00" value="{distributed_discount}" min="0" tabindex="6" />
                                                     <input type="text" readonly id="item_total_discount_{sl}" class="form-control text-right" placeholder="0.00" value="{item_total_discount}" min="0" tabindex="6" />
                                                 </td>

                                                 <td>
                                                     <input type="text" readonly id="discount_per_return_{sl}" class="form-control text-right" placeholder="0.00" value="0.00" min="0" tabindex="6" />
                                                     <input type="hidden" readonly id="distributed_discount_return_{sl}" class="distributed_discount_return form-control text-right" placeholder="0.00" value="0.00" min="0" tabindex="6" />
                                                     <input type="hidden" readonly id="item_total_discount_return_{sl}" class="form-control text-right" placeholder="0.00" value="0.00" min="0" tabindex="6" />
                                                 </td>

                                                 <td>
                                                     <input class="total_price_wd form-control text-right" type="hidden" id="total_price_wd_{sl}" value="{total_price_wd}" name="" readonly="readonly" placeholder="0.00" />
                                                     <input class="total_price_return form-control text-right" type="text" id="total_price_return_{sl}" value="0" readonly="readonly" placeholder="0.00" />
                                         ...
                                         <tfoot>
                                             ...
                                             <tr>
                                                 <td colspan="5" rowspan="15">
                                                     ...
                                                     <div class="form-group row">
                                                         ...
                                                         <input type="hidden" name="total_amount" id="total_amount" value="{net_total}">
                                                         <input type="hidden" name="old_paid" id="old_paid" value="{paid_amount}">
                                                         <label class="text-right col-form-label col-sm-4">Return:
                                                         </label>
                                                         <div class="col-sm-2 ">
                                                             <input id="cash_return" type="checkbox" name="cash_return" value="cash_ret" onclick="validation(1)" onchange="quantity_calculate_new(1)">
                                                         </div>
                                                     ...
                                                     <div class="form-group row">
                                                         ...
                                                         <div class="col-sm-2 ">
                                                             <input id="rep_toggle" type="checkbox" name="rep_or_no" onchange="quantity_calculate_new(1)" onclick="validation(1)">
                                                         </div>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="text-right">
                                                     <input type="hidden" id="sub_total" readonly class="form-control text-right" name="sub_total" value="" placeholder="0.00" />
                                                     <input type="text" id="sub_total_return" readonly class="form-control text-right" name="sub_total_return" value="" placeholder="0.00" />
                                                     ...
                                                     <input type="hidden" id="total_tax" class="form-control total_tax text-right" name="total_tax" value="{taxs}" placeholder="0.00" readonly /> -->
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="text-right">
                                                     <input type="hidden" id="total" readonly class="form-control text-right" name="total" value="0" placeholder="0.00" />
                                                     <input type="text" id="sale_discount_return" readonly class="form-control text-right" name="sale_discount_return" value="{invoice_discount}" placeholder="0.00" />
                                                     <input type="hidden" id="invoice_discount" readonly class="form-control text-right" name="invoice_discount" value="{invoice_discount}" placeholder="0.00" />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td class="text-right" colspan="3"><b>Sale Discount(%):</b></td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="text-right">
                                                     <input type="text" id="sku_discount" readonly class="form-control text-right" name="sku_discount" value="0.00" placeholder="0.00" />
                                                     <input type="hidden" id="sku_total_price_with_discount" readonly class="form-control text-right" name="sku_total_price_with_discount" value="0.00" placeholder="0.00" />

                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td class="text-right" colspan="3"><b>Total Vat:</b></td>
                                                 <td class="text-right">
                                                     <input type="text" id="total_vat" class="form-control total_vat text-right" name="total_vat" value="0.00" placeholder="0.00" readonly />

                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td class="text-right" colspan="3"><b>Total Tax:</b></td>
                                                 <td class="text-right">
                                                     <input type="text" id="total_tax" class="form-control total_tax text-right" name="total_tax" value="0.00" placeholder="0.00" readonly />
                                                 </td>
                                             </tr>
                                             ...
                                             <!-- <tr>
                                                 ...
                                                 <td class="text-right">
                                                     <input type="text" id="shipping_cost" class="form-control text-right" name="shipping_cost" readonly placeholder="0.00" value="{shipping_cost}" />
                                                 </td>
                                             </tr>
                                             <tr>
                                                 <td class="text-right" colspan="3"><b>Service Charge:</b></td>
                                                 <td class="text-right">
                                                     <input type="text" id="service_charge" class="form-control text-right" name="service_charge" readonly placeholder="0.00" value="{service_charge}" />
                                                 </td>
                                             </tr> -->
                                             ...
                                             <tr id="">
                                                 <td class="text-right font-bold" colspan="3"><b>Total:</b></td>
                                                 <td class="text-right">
                                                     <input type="text" id="total_return" class="form-control font-bold text-right" name="total_return" value="0.00" placeholder="0.00" readonly="readonly" />
                                                 </td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr id="">
                                                 ...
                                                 <td class="text-right">
                                                     <input type="text" id="sales_return" class="form-control font-bold text-right" name="sales_return" value="0.00" placeholder="0.00" readonly="readonly" />
                                                 </td>
                                             </tr>
                                             <!-- <tr class="hidden_tr">
                                                 <td class="text-right" colspan="3"><b>Delivery Charge:</b></td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td class="text-right">
                                                     <input type="text" id="total_refund" class="form-control  font-bold  text-right" name="total_refund" value="" placeholder="0.00" readonly />
                                                 </td>
                                             ...
                                             <tr class="hide_tr d-none">
                                                 ...
                                                 <td class="text-right">
                                                     <input type="text" id="cash_refund" class="form-control  font-bold  text-right" name="cash_refund" value="" placeholder="0.00" />
                                                 </td>
                                         ...
                                         <table class="table table-bordered table-hover" id="normalinvoice">
                                             <thead>
                                                 <tr>
                                                     ...
                                                     <th class="text-center "><?php echo display('total_with_discount') ?>
                                                     </th>
                                             ...
                                             <tbody id="addinvoiceItem">
                                                 <tr>
                                                     ...
                                                     <td class="text-center">
                                                         <input type="text" name="re_product_rate[]" id="re_price_item_1" class="re_price_item_1 re_price_item form-control text-right" tabindex="9" required="" value="0.00" readonly placeholder="0.00" min="0" />
                                                     </td>
                                                     <td class="text-center">
                                                         <input type="text" name="re_total_price[]" id="re_total_price_1" class="re_total_price_1 re_total_price form-control text-right" tabindex="9" required="" readonly value="0.00" placeholder="0.00" min="0" />

                                                         <input type="hidden" name="re_total_discounted_price_wd[]" id="re_total_discounted_price_wd_1" class="re_total_discounted_price_wd_1 re_total_discounted_price_wd form-control text-right" value="0.00" tabindex="9" required="" readonly placeholder="0.00" min="0" />

                                                         <input type="hidden" name="re_vat[]" id="re_vat_1" class="re_vat_1 re_vat form-control text-right" tabindex="9" readonly placeholder="0.00" value="0.00" min="0" />

                                                         <input type="hidden" name="re_vat_percent[]" id="re_vat_percent_1" class="re_vat_percent_1 re_vat_percent form-control text-right" tabindex="9" readonly placeholder="0.00" value="0.00" min="0" />

                                                         <input type="hidden" name="re_tax[]" id="re_tax_1" class="re_tax_1 re_tax form-control text-right" tabindex="9" readonly value="0.00" placeholder="0.00" min="0" />

                                                         <input type="hidden" name="re_tax_percent[]" id="re_tax_percent_1" class="re_tax_percent_1 re_tax_percent form-control text-right" tabindex="9" readonly value="0.00" placeholder="0.00" min="0" />
                                                     </td>

                                                     <td class="text-center">

                                                         <input type="text" name="re_discount[]" onkeyup="quantity_calculate_re(1);" onchange="quantity_calculate_re(1);" id="re_discount_1" class="form-control text-right" min="0" tabindex="10" value="0.00" placeholder="0.00" />

                                                         <input type="hidden" name="re_distributed_discount[]" id="re_distributed_discount_1" class="form-control text-right" min="0" value="0.00" tabindex="10" placeholder="0.00" readonly />

                                                         <input type="hidden" name="re_item_total_discount[]" id="re_item_total_discount_1" class="form-control text-right" min="0" value="0.00" tabindex="10" placeholder="0.00" readonly />
                                                     </td>


                                                     <td>
                                                         <input class="re_total_price_wd form-control text-right" type="text" name="re_total_price_wd[]" id="re_total_price_wd_1" value="0.00" readonly="readonly" />
                                             ...
                                             <tfoot>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td class="text-right" colspan="1"><b><?php echo display('sub_total') ?>:</b></td>
                                                     <td class="text-right">
                                                         <input type="text" id="re_sub_total" class="form-control text-right re_sub_total" value="0.00" name="re_sub_total" placeholder="0.00" value="0.00" readonly tabindex="13" />
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td class="text-right">
                                                         <input type="text" onkeyup="quantity_calculate_re(1);" onchange="quantity_calculate_re(1);" id="re_invoice_discount" class="form-control text-right re_total_discount" value="0.00" name="re_invoice_discount" placeholder="0.00" tabindex="13" />
                                                         <input type="hidden" id="txfieldnum">
                                                     </td>
                                                 </tr>
                                                 <tr>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td class="text-right">
                                                         ...
                                                         <input type="hidden" id="re_sku_total_price_with_discount" class="form-control text-right" name="re_sku_total_price_with_discount" value="0.00" readonly="readonly" />
                                                     </td>
                                                 </tr>

                                                 <tr>
                                                     <td colspan="7" class="text-right"><b><?php echo display('total_vat') ?>:</b></td>
                                                     <td class="text-right">
                                                         <input type="text" id="re_total_vat" class="form-control text-right" name="re_total_vat" value="0.00" readonly="readonly" />
                                                     </td>
                                                 </tr>


                                                 <tr>
                                                     <td colspan="7" class="text-right"><b><?php echo display('total_tax') ?>:</b></td>
                                                     <td class="text-right">
                                                         <input type="text" id="re_total_tax" class="form-control text-right" name="re_total_tax" value="0.00" readonly="readonly" />
                                                     </td>
                                                 </tr>
                                                 ...
                                                 <tr>
                                                     <td colspan="7" class="text-right"><b>Refunded Amount:</b></td>
                                                     <td class="text-right">
                                                         <input type="text" id="refunded_amt" class="form-control text-right" name="refunded_amt" value="0.00" readonly="readonly" />
                                                     </td>
                                                 </tr>
                                                 <tr>
                                                     <td colspan="7" class="text-right"><b><?php echo display('grand_total') ?>(With Refund):</b></td>
                                                     <td class="text-right">
                                                 ...
                                                 <tr>
                                                     <td colspan="7" class="text-right"><b>Rounding:</b></td>
                                                     <td class="text-right">
                                                 ...
                                                 <tr class="re_hide_tr d-none">
                                                     <td colspan="7" class="text-right"><b class="due_cus">Cash Refund:</b></td>
                                                     <td class="text-right">
                                                         <input type="text" id="re_cash_refund" onkeyup="quantity_calculate_new(1);" onchange="quantity_calculate_new(1);" class="form-control  font-bold  text-right" name="re_cash_refund" value="" placeholder="0.00" />
                                                     </td>

                                                 </tr>

                                                 <tr class="re_hide_tr d-none">
                                                     <td colspan="7" class="text-right"><b class="due_cus"> Customer Receivable:</b></td>
                                                     <td class="text-right">
 ...
 <script type="text/javascript">
     $("#cash_refund").change(function() {
         ...
         //  console.log(parseFloat($("#total_refund").val()));
