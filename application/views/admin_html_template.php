 ...
 <head>
     ...
     <link href="<?php echo base_url('assets/js/select2/dist/css/select2.min.css') ?>" rel="stylesheet" type="text/css"/>
 ...
 <body class="hold-transition sidebar-mini">
     ...
     <script src="<?php echo base_url('assets/js/select2/dist/js/select2.min.js') ?>" type="text/javascript"></script>
