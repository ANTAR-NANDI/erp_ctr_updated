            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="outlet_name" class="col-sm-3 col-form-label">Outlet <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="6" id="outlet_name" class="form-control" name="outlet_name" value="{outlet_name}" placeholder="<?php echo display('outlet_name') ?>" required readonly />

                                <input type="hidden" id="outlet_id" class="form-control" name="outlet_id" value="{outlet_id}" placeholder="<?php echo display('outlet_name') ?>" required readonly />
                            </div>
                        </div>
