                  ...
                  <?php echo form_open_multipart('Csms/add_update_configure', array('class' => 'form-vertical','id' => 'sms_configuration'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="api_key" class="col-sm-3 col-form-label"><?php echo display('api_key') ?> </label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="api_secret" class="col-sm-3 col-form-label"><?php echo display('api_secret') ?> </label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="from" class="col-sm-3 col-form-label"><?php echo display('from') ?> </label>
                            <div class="col-sm-6">
                   ...
                   <div class="form-group row">
                    <label for="api_secret" class="col-sm-3 col-form-label">Sms Configuration URL </label>
                    <div class="col-sm-6">
                        <input class="form-control" name ="api_url" value="<?php echo $configdata[0]['url'];?>" id="api_url" type="text" tabindex="2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="api_secret" class="col-sm-3 col-form-label">Username </label>
                    <div class="col-sm-6">
                        <input class="form-control" name ="username" value="<?php echo $configdata[0]['username'];?>" id="username" type="text" tabindex="2">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="api_secret" class="col-sm-3 col-form-label">Password </label>
                    <div class="col-sm-6">
                        <input class="form-control" name ="password" value="<?php echo $configdata[0]['password'];?>" id="password" type="password" tabindex="2">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="api_secret" class="col-sm-3 col-form-label">Sms Body </label>
                    <div class="col-sm-6">
                        <input class="form-control" name ="sms_heading" value="<?php echo $configdata[0]['sms_heading'];?>" id="sms_heading" type="text" tabindex="2">
                    </div>
                </div>
