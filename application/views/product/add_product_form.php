                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="hidden" class="form-control" name="product_id" type="text" id="product_id" placeholder="<?php echo display('barcode_or_qrcode') ?>" tabindex="1">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="product_name_bn" type="text" id="product_name_bn" placeholder="পণ্যের নাম" required tabindex="1">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="brand_id" class="col-sm-4 col-form-label">Brand Name</label>
                                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="sku" name="sku" placeholder="Product ID" />
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="sku" class="col-sm-4 col-form-label">Barcode</label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="sku" name="sku" placeholder="Product ID" />
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <!--                                <input type="button" value="--><?php //echo display('save_and_add_another') 
                                                                                                    ?><!--" name="add-product-another" class="btn btn-large btn-warning" id="add-product" tabindex="9">-->
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
