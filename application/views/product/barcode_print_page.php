                        ...
                        <div class="table-responsive">
                            ...
                            ?>
                                ...
                                <div id="printableArea">
                                    ...
                                    <table id="" style="page-break-inside:auto;" class="">
                                        <?php
                                        $counter = 0;
                                        for ($i = 0; $i < $qty; $i++) {
                                        ?>
                                            <?php if ($counter == $cqty) { ?>
                                                ...
                                                <td class="barcode-toptd" style="">
                                                    ...
                                                    <div class="barcode-inner barcode-innerdiv">
                                                        ...
                                                        <div class="product-name-details barcode-productdetails" style="text-align:center;">{product_name}</div>
                                                        <!-- <s class="price barcode-price"><?php echo (($position == 0) ? "$currency {price}" : "{price} $currency") ?>

                                                        </s> -->
                                                        <div class="price barcode-price" style="text-align:center;"><b><?php echo (($position == 0) ? "$currency {purchase_price}" : "{purchase_price} $currency") ?></b>
