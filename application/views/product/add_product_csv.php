            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body font-bold">
                        <a href="<?php echo base_url('assets/data/csv/sample_product_new.csv') ?>" class="btn btn-primary pull-right"><i class="fa fa-download"></i> Download Sample File</a>
                        <span class="">The first line in downloaded csv file should remain as it is. Please do not change the order of columns.</span><br>The correct column order is <span class="text-danger">(Product Name(Bangla), Product Name(English), Barcode, Category, Brand, Unit, Sale Price, Product Type (If type is "Finished Goods" then set 1, If type is "Raw Materials" then set 2, If type is "Tools" then set 3)) </span>separated by comma &amp; you must follow this.<br>Please make sure the csv file is UTF-8 encoded and not saved with byte order mark (BOM).
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    ...
                    <?php echo form_open_multipart('Cproduct/uploadCsv_new', array('class' => 'form-vertical', 'id' => 'validate', 'name' => 'insert_product')) ?>
