            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="outlet_name" class="col-sm-3 col-form-label">Outlet Name <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name="outlet_name" id="outlet_name" type="text" placeholder="Outlet Name" required="" value="{outlet_name}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="bin" id="bin" type="text" placeholder="BIN" value="{bin}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="mushak" id="mushak" type="text" placeholder="Mushok" value="{mushak}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="phn_no" id="phn_no" type="text" placeholder="Phone No" value="{phn_no}">
                            </div>
                        </div>
