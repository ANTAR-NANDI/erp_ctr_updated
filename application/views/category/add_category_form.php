                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body category">
                        <ul class="nav nav-tabs">
                            ...
                            <!--                            <li  class="" style="float: right !important;"> <a href="--><?php //echo base_url('Ccategory/insert_cats_ecom') 
                                                                                                                        ?><!--"  style="background-color: #E5343D;color: white !important;" class=" m-b-5 m-r-2 "><i class="fa fa-refresh"> </i>  Sync Categories</a>-->
                            </li>
                        </ul>
                            ...
                            <div id="add_category" class="tab-pane fade">
                                <div class="row cat-tabcontent">
                                    ...
                                    <div class="form-group ">
                                        <label class="col-sm-2 col-form-label" for="name">Name(In Bangla)</label>
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="ক্যাটেগরি " id="name_bn" name="name_bn" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
