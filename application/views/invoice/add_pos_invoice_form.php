                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <!--                            <div class="col-sm-6" id="payment_from_1">-->
                            <!--                                <div class="form-group row">-->
                            <!--                                    <label for="customer_name1" class="col-sm-3 col-form-label">--><?php //echo pos_display('customer_name') . '/' . display('phone') 
                                                                                                                                    ?><!-- <i class="text-danger">*</i></label>-->
                            <!--                                    <div class="col-sm-6">-->
                            <!--                                        <input type="text" size="100" name="customer_name" class="customerSelection form-control" placeholder='--><?php //echo pos_display('customer_name') . '/' . display('phone') 
                                                                                                                                                                                    ?><!--' id="customer_name" value="{customer_name}" tabindex="3" onkeyup="customer_autocomplete()" />-->
                            <!---->
                            ...
                            <!--                                        --><?php
                                                                            ...
                                                                            //                                        
                                                                            ?>
                            <!--                                            <small id="emailHelp" class="text-danger">--><?php //echo pos_display('please_add_walking_customer_for_default_customer') 
                                                                                                                            ?><!--</small>-->
                            <!--                                        --><?php
                                                                            //                                        }
                                                                            //                                        
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="addinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        if($vat == "enable"){
                                            ...
                                            $change_span += 1;
                                            $due_span += 1;
                                            $subtotal_discount_span += 1;
                                        
                                            ?>
                                        <th class="text-center invoice_fields"><?php echo pos_display('vat') ?></th>
                                        <?php } ?>
                                        <?php if($tax == "enable"){
                                            $colsp = 9;
                                            $change_span += 1;
                                        ...
                                        <th class="text-center invoice_fields"><?php echo pos_display('tax') ?>
                                        </th>
                                        <?php } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="<?php echo "5" ?> " rowspan="2">
                                        ...
                                        <td class="text-right" colspan="<?php echo $subtotal_discount_span ?>"><b><?php echo pos_display('sub_total'); ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" colspan="<?php echo $subtotal_discount_span ?>"><b><?php echo pos_display('invoice_discount') ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td class="text-right" colspan="<?php echo $colsp ?>"><b><?php echo pos_display('invoice_discount'); ?>(%):</b></td>
                                        <td class="text-right">
                                    ...
                                    <input type="hidden" id="total_vat_amount" tabindex="-1" class="form-control text-right valid" name="total_vat" value="0.00" readonly="readonly" aria-invalid="false" >
                                        ...
                                        <!-- <tr>
                                        <td class="text-right" colspan="7"><b><?php echo pos_display('total_tax') ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td colspan="<?php echo $colsp ?>" class="text-right"><b><?php echo pos_display('net_total'); ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" colspan="<?php echo $colsp ?>"><b><?php echo pos_display('paid_ammount') ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <input type="button" id="add_invoice_item" class="btn btn-info" name="add-invoice-item" onClick="addInputField2('addinvoiceItem', '<?php echo pos_display('product_name'); ?>', '<?php echo pos_display('none'); ?>','<?php echo $vat == "enable" ? 1 : 0; ?>','<?php echo $tax == "enable" ? 1 : 0; ?>')" value="<?php echo pos_display('add_new_item') ?>" tabindex="12" />
