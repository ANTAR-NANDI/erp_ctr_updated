                ...
                <div class="panel panel-bd">
                    <div id="printableArea" class="watermark" onload="printDiv('printableArea')">
                        ...
                        <div class="panel-body">
                                            ...
                                            <div class="company-content" style="margin-top: 0; text-align: justify;">
                                                ...
                                                <?php if ($sale_type == 3) { ?>
                                                    <address style=" text-align: justify;">
                                                        ...
                                                        <abbr>
                                                            <nobr>Aggregator Name: {agg_name} </nobr>
                                                        </abbr>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <address style=" text-align: justify;">
                                                        ...
                                                        <abbr>
                                                            <nobr>Name: {customer_name} </nobr>
                                                        </abbr><br>
                                                        <abbr>
                                                            <nobr>Shop Name: {shop_name} </nobr>
                                                        </abbr><br>
                                                        <abbr>
                                                            <nobr>Mobile: {customer_mobile}</nobr>
                                                        </abbr><br>
                                                        <abbr>
                                        ...
                                        <td align="right" width="300px">
                                            ...
                                            <div class=" text-right" style="margin-top:0;">
                                                ...
                                                <address>
                                                    ...
                                                    <abbr>
                                                        <nobr>Order No: {invoice_no}</nobr>
                                                    </abbr><br>
                                                    <abbr>
                                                        <nobr>Date:{final_date}</nobr>
                                                    </abbr><br>
                                                    <!--                                                    <abbr><nobr>Payment Method: {pt}</nobr></abbr><br>-->
                                                    <abbr>
                                                        <nobr>Shipping Method: {dt}</nobr>
                                                    </abbr><br>
                            ...
                            <!--                                            <span style="display: block;">--><?php //echo display('authorised_by') 
                                                                                                                ?><!--:<span>-->
                            ...
                            <!--                                            <span style="display: block;">--><?php //echo display('received_by') 
                                                                                                                ?><!--:</span>-->
                            <!--                                            <span class="text-center" style="display: block; border-top: 1px solid black; margin-top:0.5in">(Sign with Date)</span>-->
                            <!--                                        </div>-->
                            <!--                                    </div>-->
