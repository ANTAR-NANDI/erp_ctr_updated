                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <!--                                        <input type="hidden" size="100" name="deliver_type" class=" form-control"  id="deliver_type" tabindex="1"  value="--><?php //echo $delivery_type=$invoice_all_data[0]['delivery_type']
                                                                                                                                                                                                            ?><!--"  readonly/>-->
                                        <!--                                        <input type="hidden" size="100" name="courier_condtion" class=" form-control"  id="courier_condtion" tabindex="1"  value="--><?php //echo $condition=$invoice_all_data[0]['courier_condtion']
                                                                                                                                                                                                                    ?><!--"  readonly/>-->
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td class="text-right" colspan="8"><b>Service Charge:</b></td>
                                        <td class="text-right">
                                            <input type="text" id="service_charge" class="form-control text-right" name="service_charge" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" placeholder="0.00" value="{service_charge}" />
                                        </td>
                                    </tr>
