...
class Settings extends CI_Model
{
  ...
  public function read_all_pos_setting($field_name = null)
  {
    // echo "<pre>";
    // print_r($field_name);
    // exit();
    ...
    {
      $this->db->where('a.field_name',$field_name);
    }
    $this->db->from('pos_setting a');
  ...
  public function pos_setting_update($data)
  {
    // echo "<pre>";
    // print_r($data);
    // exit();
    foreach ($data as $d) {
      $this->db->where('field_name', $d['field_name']);
      $this->db->set('value', $d['value']);
      $this->db->update('pos_setting');
    }
    return true;
  }
