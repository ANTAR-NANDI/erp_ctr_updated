    ...
    public function invoice_entry()
    {
        ...
        if ($service_charge > 0) {
            $sc_income = array(
                ...
                'VDate'          =>  $Vdate,
                'COAID'          =>  308,
                'Narration'      =>  'Service Charge For Invoice No -  ' . $invoice_no_generated . ' Customer  ' . $cs_name,
        ...
        if ($total_discount > 0) {
            ...
            $dis_transaction_2 = array(
                ...
                'Narration'      =>  'Customer Discount For Invoice No -  ' . $invoice_no_generated . ' Customer  ' . $cs_name,
