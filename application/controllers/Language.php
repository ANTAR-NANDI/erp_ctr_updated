...
class Language extends CI_Controller
{
    ...
    public function editPhrase($language = null)
    {
        ...
        // echo "<pre>";
        // //print_r($_POST);
        // print_r($this->input->post('search_phrase'));
        // exit();

        $search_phrase = $this->input->post('search_phrase') ? $this->input->post('search_phrase') : null;
        // $data['phrases'] = $this->phrases($config["per_page"], $page);

        $data['phrases'] = $this->phrases_new($config["per_page"], $page, $search_phrase);
    ...
    // public function searchPhrase($language = null)
    // {
    //     echo "<pre>";
    //     print_r($_POST);
    //     // print_r($this->input->post('search_phrase'));
    ...
    public function phrases_new($per_page, $page, $search_phrase = null)
    {
        if ($this->db->table_exists($this->table)) {
            ...
            if ($this->db->field_exists($this->phrase, $this->table)) {
                ...
                if ($search_phrase) {
                    $this->db->where($this->phrase, $search_phrase);
                }
                return $this->db->order_by($this->phrase, 'asc')
                    ->limit($per_page, $page)
                    ->get($this->table)
