...
class Csettings extends CI_Controller
{
  ...
  {
    $this->load->library('lsettings');
    $content = $this->lsettings->pos_setting_list();
    $this->template->full_admin_html_view($content);
  }

  public function pos_setting_update()
  {


    $CI = &get_instance();
    $CI->load->model('Settings');
    $all_lists = $CI->Settings->read_all_pos_setting();
    ...
    foreach ($all_lists as $list) {
      $new_data = array(
        ...
        'value' => $this->input->post($list['field_name'])
      );
    ...
    if ($CI->Settings->pos_setting_update($data)) {
      #set success message
    ...
    // $CI->Settings->pos_setting_update($data);

    // redirect('Csettings/pos_setting_list');
  }
