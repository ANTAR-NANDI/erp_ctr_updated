...
// newdiv.innerHTML ='<td class="span3 supplier"><input type="text" name="product_name" required="" class="form-control product_name productSelection" onkeypress="product_pur_or_list('+ count +');" placeholder="Pr. Name" id="product_name_'+ count +'" tabindex="'+tab1+'"> <input type="hidden" class="autocomplete_hidden_value product_id_'+ count +'" name="product_id[]" id="SchoolHiddenId" /> <input type="hidden" class="sl" value="'+ count +'"> </td>
<td class="wt"> <input type="text" placeholder="SN" name="sn[]" id="sn_'+ count +'" class="form-control text-right stock_ctn_1_'+ count +'" /></td>
...
<td class="wt"> <input type="number" placeholder="Lot number" name="lot_number[]" id="lot_number_'+ count +'" class="form-control text-right stock_ctn_1_'+ count +'" /></td>
<td class="wt"> <input type="text" placeholder="Origin" name="origin[]" id="origin_'+ count +'" class="form-control text-right stock_ctn_1_'+ count +'" /></td>
<td class="wt"> <input type="text" placeholder="Warehouse" name="warehouse[]" id="shelf_number_'+ count +'" class="form-control text-right stock_ctn_1_'+ count +'" /></td>
<td class="text-right"> <input type="date" style="width: 110px" id="warrenty_date_'+count+'" class="form-control_'+count+'" name="warrenty_date[]" id="date" /> </td>
<td class="text-right"> <input type="date" style="width: 110px" id="expired_date_'+count+'" class="form-control_'+count+'" name="expired_date[]" id="date" /> </td>
<td class="text-right"><input type="text" name="product_quantity[]" tabindex="'+tab2+'" required id="cartoon_'+ count +'" class="form-control text-right store_cal_' + count + '" onkeyup="calculate_store(' + count + ');" onchange="calculate_store(' + count + ');" placeholder="0.00" value="" min="0" /> </td>
<td class="test"><input type="text" name="product_rate[]" onkeyup="calculate_store('+ count +');" onchange="calculate_store('+ count +');" id="product_rate_'+ count +'" class="form-control product_rate_'+ count +' text-right" placeholder="0.00" value="" min="0" tabindex="'+tab3+'" /></td>
<td class="text-right"><input class="form-control total_price text-right total_price_'+ count +'" type="text" name="total_price[]" id="total_price_'+ count +'" value="0.00" readonly="readonly" /> </td>
<td> <input type="hidden" id="total_discount_1" class="" /><input type="hidden" id="all_discount_1" class="total_discount" /><button style="text-align: right;" class="btn btn-danger red" type="button" onclick="deleteRow(this)" tabindex="10"><i class="fa fa-close"></i></button></td>';
newdiv.innerHTML ='<td class="span3 supplier"><input type="text" name="product_name" required="" class="form-control product_name productSelection" onkeypress="product_pur_or_list('+ count +');" placeholder="Purchase Order" id="product_name_'+ count +'" tabindex="'+tab1+'"> <input type="hidden" class="autocomplete_hidden_value product_id_'+ count +'" name="product_id[]" id="SchoolHiddenId" /> <input type="hidden" class="sl" value="'+ count +'"> </td>
<td class="wt"> <input type="text" id="pr_ame_'+ count +'" class="form-control text-right stock_ctn_'+ count +'" placeholder="Product Name" readonly /> <input type="hidden" class="autocomplete_hidden_value stock_ctn_'+ count +'" name="p_id[]" id="p_id_'+ count +'" /></td>
<td class="text-right"><input type="text" name="product_quantity[]" tabindex="'+tab2+'" required id="cartoon_'+ count +'" class="form-control text-right store_cal_' + count + '" onkeyup="calculate_store(' + count + ');" onchange="calculate_store(' + count + ');" placeholder="0.00" value="" min="0" readonly /> </td>
<td class="test"><input type="text" name="product_rate[]" onkeyup="calculate_store('+ count +');" onchange="calculate_store('+ count +');" id="product_rate_'+ count +'" class="form-control product_rate_'+ count +' text-right" placeholder="0.00" value="" min="0" tabindex="'+tab3+'" /></td>
<td class="text-right"><input class="form-control total_price text-right total_price_'+ count +'" type="text" name="total_price[]" id="total_price_'+ count +'" value="0.00" readonly="readonly" /> </td>
<td> <input type="hidden" id="total_discount_1" class="" /><input type="hidden" id="all_discount_1" class="total_discount" /><button style="text-align: right;" class="btn btn-danger red" type="button" onclick="deleteRow(this)" tabindex="10"><i class="fa fa-close"></i></button></td>';
